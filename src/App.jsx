    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6 antialiased lg:flex jusify-center iems-center" >
        <section className="lg:flex">
          <div className="bg-orange p-12 rounded-t-lg">
            ...
            <a href="https://www.webmotors.com.br/suvs" target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange">Ver Mais</a>
          </div>
          ...
          <div className="bg-dark-green p-12 rounded-b-lg">
            ...
            w-fit rounded-3xl text-dark-green">Ver Mais</a>
