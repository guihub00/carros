...
export default function Sedans() {
    ...
    return (
        ...
        <section className="bg-orange p-12 max-lg:rounded-t-lg lg:rounded-l-lg">
            ...
            <a href="https://www.webmotors.com.br/suvs" target="_blank" className="font-lexend bg-offwhitebg px-10 py-3 block w-fit rounded-3xl text-orange border-2 border-offwhitebg hover:bg-orange hover:text-offwhitebg">Ver Mais</a>
          </section>
